...
class TravelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create travel" do
    assert_difference('Travel.count') do
      post travels_url, params: { travel: { card_id: @travel.card_id, vehicle_id: @travel.vehicle_id } }
    end
  ...
  test "should update travel" do
    patch travel_url(@travel), params: { travel: { card_id: @travel.card_id, vehicle_id: @travel.vehicle_id } }
